/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8afaa0eb77b712943b067406c112fd97)
// Runtime types generated with workerd@1.20260915.1 2026-09-16 nodejs_compat
interface __BaseEnv_Env {
	TURN_MONTHLY_EGRESS_LIMIT_BYTES: "1000000000000";
	TARGET_RELAY: DurableObjectNamespace<import("./src/index").TargetRelay>;
	TURN_QUOTA: DurableObjectNamespace<import("./src/index").TurnQuota>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TargetRelay" | "TurnQuota";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURN_MONTHLY_EGRESS_LIMIT_BYTES">> {}
}
